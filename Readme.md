...
|------------------|----------------------------------------------------------|
|GNS3 (Graphical Network Simulator)|émulateur de réseaux. Permet de up, configurer, tester et déboguer des machines et leurs liens. |
...
- Étapes de la partie 2
    ...
    - ```ip addr add 192.168.1.1/24 dev eth0``` (ou 2 pour le 2e routeur)  = créer une adresse ip statique pour chaque routeur (en précisant l’interface => eth0 dans l’exemple)
...
- Étapes de la partie 3
	...
	- Pour chaque routeur, créer un bridge br0 et un VXLAN vxlan10 comme dans la partie 2 => fait par le script vxlan.sh 
